    ...
    private function getAnswerKeySection2($examId)
    {
        ...
        if ($examId == 1) {
            ...
            return [
                ...
                9 => 'A', 10 => 'A', 11 => 'C', 12 => 'A', 13 => 'A', 14 => 'C', 15 => 'B', 16 => 'B',
                17 => 'A', 18 => 'D', 19 => 'A', 20 => 'B', 21 => 'D', 22 => 'A', 23 => 'A', 24 => 'C',
                25 => 'A', 26 => 'C', 27 => 'B', 28 => 'A', 29 => 'D', 30 => 'B', 31 => 'A', 32 => 'C',
                33 => 'B', 34 => 'A', 35 => 'C', 36 => 'C', 37 => 'B', 38 => 'C', 39 => 'D', 40 => 'C'
            ];
        } else {
            echo "id exam tidak ditemukan";
        }
