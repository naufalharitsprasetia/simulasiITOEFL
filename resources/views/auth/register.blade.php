        ...
        <div class="max-w-md w-full mx-auto">
            ...
            <form action="/register" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Full Name -->
                    <div class="relative">
                        <label for="name" class="block text-sm lg:text-base font-medium text-gray-700 mb-2">Full
                            Name</label>
                    ...
                    <div class="relative">
                        <label for="username"
                            class="block text-sm lg:text-base font-medium text-gray-700 mb-2">Username</label>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        <label for="password_confirmation"
                            class="block text-sm lg:text-base font-medium text-gray-700 mb-2">Password
                            Confirmation</label>
