        ...
        <div class="w-full p-4">
            <div class="bg-white shadow-lg rounded-lg p-6 scrollable">
                ...
                <p class="text-justify leading-relaxed w-[400px]">
                    ...
                    examining <strong>several representative handfuls</strong>. To determine soil texture, sand, silt,
                    and clay
                    particles are <strong>separated</strong> by size and weight, and their respective weights are then
                    calculated as
                    ...
                    clay present in the sample. Clay particles are very cohesive and, when <strong>wet</strong>, act
                    like a plastic
                    ...
                    high clay content, the <strong>fine</strong> particles are measured based on their settling speed in
                    water. Since
                    clay particles settle very slowly, <strong>they</strong> can easily be separated from sand and silt.
                    The water can
