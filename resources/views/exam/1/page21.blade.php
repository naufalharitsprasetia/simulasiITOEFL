        ...
        <div class="w-full p-4">
            <div class="bg-white shadow-lg rounded-lg p-6 scrollable">
                ...
                <p class="text-justify leading-relaxed w-[400px]">
                    ...
                    contradict them. <strong>Here</strong>, it may reveal, consciously or unconsciously, emotions like
                    sympathy,
                    ...
                    that <strong>relies on</strong> specific techniques using voice and gestures. The success of
                    <strong>artistic, political, or pedagogical communication</strong> is determined by the motivation
                    drawn from the text, and for singing,
                    ...
                    tone can change based on how they <strong>perceive</strong> the listener’s receptiveness, interest,
                    or empathy,
                    either encouraging or discouraging them. Emotional health is also <strong>reflected</strong> in the
                    voice; happiness
