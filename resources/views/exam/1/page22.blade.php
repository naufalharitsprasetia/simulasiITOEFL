        ...
        <div class="w-full p-4">
            <div class="bg-white shadow-lg rounded-lg p-6 scrollable">
                ...
                <p class="text-justify leading-relaxed w-[400px]">
                    ...
                    social advancement. Schools were also seen as the most significant <strong>means</strong> for
                    integrating immigrants
                    into American society.
                    <!-- The full passage continues here --> <br> <br>
                    The arrival of many southern and eastern European immigrants around this time <strong>led
                        to</strong> a significant
                    ...
                    homemakers by focusing on cooking, shopping, decorating, and child care in <strong>their</strong>
                    own homes, or, if
