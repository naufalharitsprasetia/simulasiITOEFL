        ...
        <div class="w-full p-4">
            <div class="bg-white shadow-lg rounded-lg p-6 scrollable">
                ...
                <p class="text-justify leading-relaxed w-[400px]">
                    ...
                    on the detection of <strong>seismic waves</strong>, the vibrations caused by
                    <strong>earthquakes</strong>. These waves travel through
                    ...
                    responsible for the generation of Earth’s <strong>magnetic field</strong>, but nobody has ever been
                    able to work out
                    ...
                    molten rock. Once a cool crust had formed around the molten ball of rock, <strong>it
                        functioned</strong> as an
                    ...
                    stars), which decay into <strong>stable elements</strong> and give out energy as they do so. In
                    about ten
        ...
        <div class="w-full p-4">
            <div class="scrollable" style="width: 600px;">
                <div class="bg-white shadow-lg rounded-lg p-6 w-[800px]">
                    ...
                    <!-- Question 17 -->
                    <div class="mb-6">
                        <p class="text-md">17. The word “functioned” in the 3rd paragraph on line 4 is closest in
                            meaning to</p>
                        <ul class="space-y-2 mt-4 text-sm">
                            <li>
                                <label>
                    ...
                    <!-- Question 18 -->
                    <div class="mb-6">
                        <p class="text-md">18. The word “manufactured” in the 3rd paragraph on line 9 is closest in
                            meaning to </p>
                        <ul class="space-y-2 mt-4 text-sm">
                            <li>
                                <label>
                    ...
                    <!-- Question 20 -->
                    <div class="mb-6">
                        <p class="text-md">20. Look at the terms“seismic waves” (1st paragraph),“earthquakes” (1st
                            paragraph),
                            “magnetic field” (2nd paragraph), and “stable elements” (3rd paragraph). Which of these
                            terms is
