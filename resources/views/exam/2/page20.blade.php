        ...
        <div class="w-full p-4">
            <div class="bg-white shadow-lg rounded-lg p-6 scrollable">
                ...
                <p class="text-justify leading-relaxed w-[400px]">
                    ...
                    organisms in amber are strikingly <strong>intact</strong>. Exquisite preservation is a natural
                    property
                    of certain kinds of resins, although the process is not completely understood
                    <!-- The full passage continues here --> <br> <br>
                    Hundreds of deposits of amber occur around the world, most of them in <strong>trace</strong>
                    quantities. Amber is
                    ...
                    deposits vary greatly in age. It is a common <strong>misconception</strong> that amber is derived
                    exclusively from
                    pine trees; in fact, amber was formed by various conifer trees (only a few of <strong>them</strong>
                    apparently
                    ...
                    Over time, sediments would gradually <strong>bury</strong> the wood and resin. The resin would
                    become
