<div class="begginer-wrapper px-28 py-24">
    ...
    <div class="body-container mt-12">
        <p class="font-semibold text-center">
            Direction: In this part of the test, you will hear longer conversations. After each conversation, you will
    ...
    <audio autoplay loop style="display: none;">
        <source src="{{ asset('audio2/partB/PartBdirections.mp3.mp3') }}" type="audio/mpeg">
